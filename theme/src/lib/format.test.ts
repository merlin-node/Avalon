...
import {
  axisBytes, axisTop, bytes, compact, cpuName, daysUntil, distro, duration, money, monthUsage, osName, pair, quarters,
...
{
  eq(money(12, "$"), "$12.00", "符号放前面")
  eq(money(12, "C$"), "C$12.00", "以符号结尾的放前面")
  eq(money(12, "cad"), "12.00 cad", "原样显示，大小写不动")
  eq(money(12, "USD"), "12.00 USD", "不再把代码换成符号")
  eq(money(12, "元"), "12.00 元", "中文单位放后面")
  eq(money(12, ""), "12.00", "没填单位只显示数字")
}
